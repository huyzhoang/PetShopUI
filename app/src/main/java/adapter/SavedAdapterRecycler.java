...
public class SavedAdapterRecycler extends RecyclerView.Adapter<SavedAdapterRecycler.ViewHolder> {

    private Context context;
    private ArrayList<FavoriteModel> modelRecyclerArrayList;

    public SavedAdapterRecycler(Context context, ArrayList<FavoriteModel> modelRecyclerArrayList) {
        this.context = context;
        this.modelRecyclerArrayList = modelRecyclerArrayList;
    }

    @Override
    public SavedAdapterRecycler.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(SavedAdapterRecycler.ViewHolder holder, int position) {
